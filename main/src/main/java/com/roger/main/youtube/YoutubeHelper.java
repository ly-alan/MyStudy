...
import com.roger.main.youtube.dynamicparse.ConfigParser;
import com.roger.main.youtube.dynamicparse.GvAgainParser;
import com.roger.main.youtube.dynamicparse.GvParser;
import com.roger.main.youtube.dynamicparse.IParserHandler;
...
/**
 * Created by zhangyaoa on 2023/7/11.
 */
...
//    }
    ...
    private static String cipherParse(String sign, UrlSyntax urlSyntax) {
        ...
        for (MethodValue methodValue : urlSyntax.getMethodInvokes()) {
            ...
            switch (methodName) {
                case "gT":
                    Log.d(TAG, "cipherParse method: gT, value: " + value);
                    result = gtInvoke.apply(result, value);
                    break;
                case "KQ":
                    Log.d(TAG, "cipherParse method: KQ, value: " + value);
                    result = KQInvoke.apply(result, value);
                    break;
                case "d3":
                    Log.d(TAG, "cipherParse method: d3, value: " + value);
