 ...
 * the License.
 */
package com.roger.tvmodule.leanback;
...
//            Log.d("liao", "setFocusLevel : " + level + " : scaleDiff : " + mScaleDiff);
            mFocusLevel = level;
            float scaleX = 1f + mScaleDiff * level;
            float scaleY = 1f + mScaleDiff * level;
